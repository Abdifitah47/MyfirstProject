  ...
  for (let c = 0; c < t.length; c++) {
    ...
    if (p === ye) (l += t.slice(c, c + 2)), (c += 1);
      ...
      for (let h = c + 1; h < t.length; h++)
        if (((d = t.charCodeAt(h)), d === ye)) h += 1;
          ...
          if (d === Re && t.charCodeAt(h + 1) === oe)
            throw new Error(
              `Unterminated string: ${
                t.slice(m, h + 1) + String.fromCharCode(p)
              }`
            );
          if (d === oe)
            throw new Error(
              `Unterminated string: ${t.slice(m, h) + String.fromCharCode(p)}`
            );
        }
      l += t.slice(m, c + 1);
    } else {
      ...
      if (p === oe) {
        ...
        (s = ke(l)), n ? n.nodes.push(s) : r.push(s), (l = ""), (s = null);
...
function ze(t, r, o = [], e = {}) {
  for (let n = 0; n < t.length; n++) {
    ...
    if (s.kind === "rule" || s.kind === "at-rule")
      o.push(s), ze(s.nodes, r, o, e), o.pop();
...
function _t(t) {
  ...
  _e.some((n) => t.includes(n)) &&
    ((Pt.lastIndex = 0),
    (t = t.replace(Pt, (n, s) => ((r = !0), `$${_e.indexOf(s)}$(`))));
  let o = "",
    e = [];
  for (let n = 0; n < t.length; n++) {
    let s = t[n];
...
function* Ft(t, r) {
  ...
  if (l[l.length - 1] === "]") {
    ...
    let y = l.slice(m + 2, -1),
      ...
      b = null;
    if (
      (v.length === 2 && ((b = v[0]), (y = v[1])), y[0] !== "-" && y[1] !== "-")
    )
      return;
  ...
  for (let [m, h] of p) {
    ...
    }
    {
      ...
      if (v !== -1) {
        ...
        let x =
          f === null || y.modifier?.kind === "arbitrary" ? null : `${h}/${f}`;
    ...
    for (let [l, f] of s)
      switch (r.variants.kind(l)) {
        ...
        case "functional": {
          ...
          if (f === null)
            return { kind: "functional", root: l, modifier: d, value: null };
          if (f[f.length - 1] === "]") {
            if (f[0] !== "[") continue;
        ...
        case "compound": {
          ...
          return e !== null && c === null
            ? null
            : { kind: "compound", root: l, modifier: c, variant: d };
        }
      }
  }
  return null;
  ...
  return K(t, ",")
    .map((e) => {
      ...
      for (let c of n)
        Io.has(c) ||
          (qt.test(c)
            ? (l === null ? (l = c) : f === null && (f = c), (qt.lastIndex = 0))
            : s === null && (s = c));
...
var Lo = /^-?[a-z][a-zA-Z0-9/%._-]*$/,
  ...
  st = class {
    ...
    has(r, o) {
      return (
        this.utilities.has(r) && this.utilities.get(r).some((e) => e.kind === o)
      );
    }
    get(r) {
...
function Gt(t) {
  ...
  function e(i, u) {
    r.static(i, () =>
      u.map((g) => (typeof g == "function" ? g() : a(g[0], g[1])))
    );
  }
  function n(i, u) {
        ...
        if (k.value)
          if (k.value.kind === "arbitrary") {
            ...
            if (T === null && w && u.handleNegativeBareValue) {
              if (
                ((T = u.handleNegativeBareValue(k.value)),
    ...
    r.functional(i, (g) => {
      ...
      if (
        (g.value.kind === "arbitrary"
          ? ((w = g.value.value), (w = W(w, g.modifier, t)))
          : (w = G(g, t, u.themeKeys)),
        w !== null)
      )
        return u.handle(w);
  ...
  let c = () =>
    D([$("--tw-scale-x", "1"), $("--tw-scale-y", "1"), $("--tw-scale-z", "1")]);
  ...
  function m({ negative: i }) {
    return (u) => {
      ...
      if (u.value.kind === "arbitrary") {
        ...
        ((g = t.resolve(u.value.value, ["--rotate"])),
    ...
    ]);
  {
    ...
    for (let g of ["x", "y", "z"])
      n(`rotate-${g}`, {
        ...
        handle: (w) => [
          u(),
          a(`--tw-rotate-${g}`, `rotate${g.toUpperCase()}(${w})`),
          a("transform", i),
        ],
      }),
        o(`rotate-${g}`, () => [
    ...
    n("skew", {
      ...
      r.functional("transform", (g) => {
        ...
        if (
          (g.value
            ? g.value.kind === "arbitrary" && (w = g.value.value)
            : (w = i),
          w !== null)
        )
  ...
  e("grid-flow-row", [["grid-auto-flow", "row"]]),
    ...
    n("grid-cols", {
      ...
      handleBareValue: ({ value: i }) =>
        N(i) ? `repeat(${i}, minmax(0, 1fr))` : null,
      ...
      r.functional(g, (k) => {
        ...
        if (k.value.kind === "arbitrary") {
          ...
          switch (k.value.dataType ?? F(T, ["color", "line-width", "length"])) {
            ...
            default:
              return (
                (T = W(T, k.modifier, t)), T === null ? void 0 : w.color(T)
              );
          }
        }
        {
        ...
        handle: (g) => [
          ...
          U(":where(& > :not(:last-child))", [
            ...
            a(
              ...
              `calc(${g} * var(--tw-divide-x-reverse))`
            ),
            a(
              "border-inline-end-width",
              `calc(${g} * calc(1 - var(--tw-divide-x-reverse)))`
            ),
          ]),
        ],
      }),
      n("divide-y", {
        ...
        handle: (g) => [
          ...
          U(":where(& > :not(:last-child))", [
            ...
            a(
              "border-bottom-width",
              `calc(${g} * calc(1 - var(--tw-divide-y-reverse)))`
            ),
          ]),
        ],
      }),
      ...
      if (g.value) {
        if (g.value.kind === "arbitrary") {
          ...
          switch (g.value.dataType ?? F(w, ["color", "length", "percentage"])) {
            ...
            default:
              return (
                (w = W(w, g.modifier, t)), w === null ? void 0 : u.color(w)
              );
          }
        }
        {
        ...
        }
        {
          ...
          if (
            g.value.value[g.value.value.length - 1] === "%" &&
            N(g.value.value.slice(0, -1))
          )
    ...
    r.functional("stroke", (i) => {
      if (i.value) {
        if (i.value.kind === "arbitrary") {
          ...
          switch (
            i.value.dataType ??
            F(u, ["color", "number", "length", "percentage"])
          ) {
            case "number":
            case "length":
            case "percentage":
    ...
    r.functional("font", (i) => {
      if (!(!i.value || i.modifier)) {
        if (i.value.kind === "arbitrary") {
          ...
          switch (
            i.value.dataType ??
            F(u, ["number", "generic-name", "family-name"])
          ) {
            case "generic-name":
            case "family-name":
    ...
    r.static("outline-hidden", () => [
      ...
      r.functional("outline", (u) => {
        ...
        if (u.value.kind === "arbitrary") {
          ...
          switch (
            u.value.dataType ??
            F(g, ["color", "length", "number", "percentage"])
          ) {
            case "length":
            case "number":
            case "percentage":
      ...
      if (i.value) {
        if (i.value.kind === "arbitrary") {
          ...
          switch (
            ...
            default:
              return (
                (u = W(u, i.modifier, t)), u === null ? void 0 : [a("color", u)]
              );
          }
        }
        {
      ...
      r.functional("shadow", (C) => {
        ...
        switch (C.value.value) {
          case "none":
            return C.modifier
              ? void 0
              : [g(), a("--tw-shadow", u), a("box-shadow", i)];
        }
        {
      ...
      r.functional("inset-shadow", (C) => {
            ...
            default:
              return [
                ...
                a(
                  ...
                  `inset ${ae(
                    A,
                    (Te) => `var(--tw-inset-shadow-color, ${Te})`
                  )}`
                ),
                a("box-shadow", i),
              ];
        ...
        switch (C.value.value) {
          case "none":
            return C.modifier
              ? void 0
              : [g(), a("--tw-inset-shadow", u), a("box-shadow", i)];
        }
        {
    ...
    r.functional("ring", (C) => {
      ...
      if (C.value.kind === "arbitrary") {
        ...
        switch (C.value.dataType ?? F(A, ["color", "length"])) {
          case "length":
            return C.modifier
              ? void 0
              : [g(), a("--tw-ring-shadow", k(A)), a("box-shadow", i)];
          default:
            return (
              (A = W(A, C.modifier, t)),
      ...
      r.functional("inset-ring", (C) => {
        if (!C.value)
          return C.modifier
            ? void 0
            : [g(), a("--tw-inset-ring-shadow", T("1px")), a("box-shadow", i)];
        if (C.value.kind === "arbitrary") {
          let A = C.value.value;
          switch (C.value.dataType ?? F(A, ["color", "length"])) {
            case "length":
              return C.modifier
                ? void 0
                : [g(), a("--tw-inset-ring-shadow", T(A)), a("box-shadow", i)];
            default:
              return (
                (A = W(A, C.modifier, t)),
    ...
    ? (o) => {
        ...
        _(t.nodes, (s) => {
          ...
          fe(l, (f) => {
            if (
              f.kind !== "function" ||
              (f.value !== "--value" && f.value !== "--modifier")
            )
              return;
            let d = K(H(f.nodes), ",");
...
var ut = { "--alpha": Wo, "--spacing": Bo, "--theme": qo, theme: Qt };
function Wo(t, r, ...o) {
  ...
  for (let o of t.utilities.keys("functional")) {
    ...
    for (let n of e)
      for (let s of n.values) {
        let l = s === null ? o : `${o}-${s}`;
        r.push([l, { modifiers: n.modifiers }]),
          n.supportsNegative && r.push([`-${l}`, { modifiers: n.modifiers }]);
      }
  }
...
function or(t) {
  ...
  function l(c) {
    return c.includes("::")
      ...
      : `&:not(${K(c, ",")
          .map(
            (m) => (
              m.startsWith("&:is(") && m.endsWith(")") && (m = m.slice(5, -1)),
              (m = m.replaceAll("&", "*")),
              m
            )
          )
    ...
    o("backdrop", ["&::backdrop"]);
  {
    ...
    r.static(
      ...
      (p) => {
        p.nodes = [
          U("&::before", [c(), a("content", "var(--tw-content)"), ...p.nodes]),
        ];
      },
      { compounds: 0 }
    ),
      r.static(
        ...
        (p) => {
          p.nodes = [
            U("&::after", [c(), a("content", "var(--tw-content)"), ...p.nodes]),
          ];
        },
        { compounds: 0 }
      );
  ...
  o("first", ["&:first-child"]),
    ...
    r.functional("nth", (c, p) => {
      if (
        !p.value ||
        p.modifier ||
        (p.value.kind === "named" && !N(p.value.value))
      )
        return null;
            ...
            case "functional": {
              ...
              return (
                h.value.kind === "arbitrary"
                  ? (y = h.value.value)
                  : h.value.kind === "named" &&
                    (y = t.resolveValue(h.value.value, ["--breakpoint"])),
            ...
            case "functional": {
              ...
              return (
                h.value.kind === "arbitrary"
                  ? (y = h.value.value)
                  : h.value.kind === "named" &&
                    (y = t.resolveValue(h.value.value, ["--container"])),
                !y || y.includes("var(") ? null : y
              );
            }
            case "static":
  ...
  let r = Gt(t),
    ...
    l = {
      ...
      getVariantOrder() {
        ...
        for (let m of f)
          m !== null &&
            (c !== void 0 && this.variants.compare(c, m) !== 0 && p++,
            d.set(m, p),
            (c = m));
        return d;
      },
  ...
  return (
    n.sort((f, d) => {
      ...
      for (
        ...
        p.properties.length < m &&
        c.properties[m] === p.properties[m];
...
function ur(t) {
  for (let r of t)
    r.kind !== "at-root" &&
      (r.kind === "declaration"
        ? (r.important = !0)
        : (r.kind === "rule" || r.kind === "at-rule") && ur(r.nodes));
}
function Yo(t) {
  let r = new Set(),
    o = t.slice();
...
${Y([y])}`))
      ...
      for (let y of s.get(m))
        for (let v of l.get(y)) h.push(m), p(v, h), h.pop();
          ...
          s.push(
            (async () => {
              ...
              await mt(b, v.base, o, e + 1),
                (y.nodes = Zo([ne({ base: v.base }, b)], p, m, h));
            })()
          ),
          f(y),
          1
  ...
  keysInNamespaces(r) {
    ...
    for (let e of r) {
      ...
      for (let s of this.values.keys())
        s.startsWith(n) &&
          s.indexOf("--", 2) === -1 &&
          (fr(s, e) || o.push(s.slice(n.length)));
    }
    return o;
  }
  get(r) {
    ...
    let e = 5;
    {
      ...
      n &&
        ...
        t.theme.add(
          ...
          he(r.fontFamily.sans, "fontFeatureSettings") ?? "normal",
          e
        ),
        t.theme.add(
  ...
  return function (n, s) {
    ...
    let d = (() => {
      ...
      if (h !== null && typeof h == "object" && !Array.isArray(h)) {
        ...
        for (let v in p)
          v !== "__CSS_VALUES__" &&
            ((h?.__CSS_VALUES__?.[v] & 4 && hr(y, v.split("-")) !== void 0) ||
              (y[ar(v)] = p[v]));
        return y;
      }
    ...
    matchUtilities(l, f) {
      ...
      for (let [p, m] of Object.entries(l)) {
        let h = function ({ negative: y }) {
          return (v) => {
            if (
              ...
              d.length > 0 &&
              !d.includes("any") &&
              ((v.value.dataType && !d.includes(v.value.dataType)) ||
                (!v.value.dataType && !F(v.value.value, d)))
            )
              return;
                ...
                v.value
                  ? v.value.kind === "arbitrary"
                    ...
                    : E.__BARE_VALUE__ &&
                      ...
                      (S =
                        (v.value.fraction !== null && x?.includes("/")) ?? !1))
                  : (x = E.DEFAULT ?? null);
            }
            if (x === null) return;
            let V;
        ...
        f?.supportsNegativeValues &&
          t.utilities.functional(`-${p}`, h({ negative: !0 }), { types: d }),
...
function bt(t, { config: r, base: o, path: e, reference: n }) {
  ...
  for (let d of r.presets ?? [])
    bt(t, { path: e, base: o, config: d, reference: n });
  for (let d of s)
    t.plugins.push(d),
      d.config &&
        bt(t, { path: e, base: o, config: d.config, reference: !!d.reference });
  let l = r.content ?? [],
    f = Array.isArray(l) ? l : l.files;
  for (let d of f)
    t.content.files.push(typeof d == "object" ? d : { base: o, pattern: d });
  t.configs.push(r);
}
function vn(t) {
  let r = new Set(),
...
function kn({ center: t, padding: r, screens: o }, e) {
  ...
  if (
    ...
    if ((l.sort((f, d) => le(f[1], d[1], "asc")), l.length > 0)) {
      let [f] = l[0];
      n.push(
        P("@media", `(width >= --theme(--breakpoint-${f}))`, [
          a("max-width", "none"),
        ])
      );
    }
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
        ...
        l.push([
          { id: b, base: v.base, reference: !!v.reference },
...
function Ir({
  ...
  for (let { handler: b, reference: x } of c.plugins)
    x ? ((v ||= ht({ ...h, referenceMode: !0 })), b(v)) : b(y);
  if (
    (mr(t, p, m),
    Rr(t, p, m),
    Fr(p, t),
...
async function Sn(
  t,
  { base: r = "", loadModule: o = Cn, loadStylesheet: e = $n } = {}
) {
  let n = 0;
    ...
    if (b.kind === "at-rule") {
      ...
      if (
        ...
        if (b.nodes.length > 0 && E)
          throw new Error(
            `\`@custom-variant ${R}\` cannot have both a selector and a body.`
          );
        if (b.nodes.length === 0) {
          if (!E)
            throw new Error(
              `\`@custom-variant ${R}\` has no selector or body.`
            );
          let z = K(E.slice(1, -1), ","),
            i = [],
            u = [];
        ...
        for (let z of R)
          if (z.startsWith("source(")) {
            ...
            z === "important"
              ...
              : E.push(z);
        return (
          E.length > 0 ? (b.params = E.join(" ")) : R.length > 0 && S(b.nodes),
          1
        );
      }
      if (b.name === "@theme") {
...
${u}`);
  ...
  if (c) {
    ...
    if (x.length > 0) {
      let S = [...l.namespace("--animate").values()].flatMap((V) =>
        V.split(" ")
      );
      for (let V of x) {
        let R = V.params;
...
async function Tn(t, r = {}) {
  ...
  e.unshift(
    Ke(`! tailwindcss v${xt} | MIT License | https://tailwindcss.com `)
  );
  function d(h) {
  ...
  return {
    ...
    build(h) {
      ...
      let y = !1,
        v = c.size;
      for (let x of h)
        o.invalidCandidates.has(x) || (c.add(x), (y ||= c.size !== v));
      if (!y) return (p ??= ie(e)), p;
      let b = te(c, o, { onInvalidCandidate: d }).astNodes;
      return m === b.length
        ? ((p ??= ie(e)), p)
        : ((m = b.length), (l.nodes = b), (p = ie(e)), p);
    },
  };
}
...
`;
var Se = { index: Wr, preflight: Br, theme: qr, utilities: Hr };
var Ge = class {
  start(r) {
...
async function Dn(t, r) {
  ...
  try {
    let e = o();
    return (
      B.hit("Loaded stylesheet", { id: t, base: r, size: e.content.length }), e
    );
  } catch (e) {
    throw (
...
async function jn(t) {
  ...
  for (let o of document.querySelectorAll("[class]"))
    for (let e of o.classList) kt.has(e) || (kt.add(e), r.add(e));
